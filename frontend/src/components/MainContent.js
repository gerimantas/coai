    ...
    <div className="flex min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6">
          ...
          <Card className="mb-4">
            <div className="font-medium text-base mb-1">Aktyvus projektas: {projectInfo.name}</div>
          ...
          <h1 className="text-lg font-medium mb-4 text-foreground">Welcome to the UI Template</h1>
          <Card>
